...
def fakeEmail():
  faker = Faker()
  print ('')
  print (Fore.WHITE + Style.BRIGHT + ' [ Tool Random Email ]')
  print ('')
  data_kytu = ['', '_', '.']
  so_luong = int(input(Fore.WHITE + Style.BRIGHT + " -Nhập Số Lượng : "))
  Domain = input(Fore.WHITE + Style.BRIGHT + " -Nhập Domain(ex: yahoo) : ")
  file_email = input(Fore.WHITE + Style.BRIGHT + " -Nhập File Lưu(ex: email.txt) : ")
  n = 0
  for fake in range(so_luong):
    ...
    print (Fore.WHITE + Style.BRIGHT + " [" + str(n) + "] " + fake_email)
...
def checkhotmail():
  print ('')
  print (Fore.WHITE + Style.BRIGHT + ' [ Tool Check Hotmail ]')
  print ('')
...
def checkyahoo():
  print ("")
  print (Fore.WHITE + Style.BRIGHT + " [ Tool Check Yahoo ]")
  print ("")
  print (Fore.WHITE + Style.BRIGHT + " •CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
  n_yahoo = 0
  yahoo = open(input(Fore.WHITE + Style.BRIGHT + " -Nhập File Yahoo(ex: yahoo.txt) : ")).readlines()
  yahoo_die = input(Fore.WHITE + Style.BRIGHT + " -Nhập File Lưu Yahoo Die(ex: yahoodie.txt) : ")
  for line_yahoo in yahoo:
    n_yahoo += 1
    yid = line_yahoo[0:line_yahoo.index('@')]
    cookies = {
    'OTH': 'v=1& datr=xfLJYte5_9dPkTEOvOk79M_M;sb=xvLJYvIMBSjIzi0A7pVG-NiV;m_pixel_ratio=2.700000047683716;x-referer=%3D;locale=vi_VN;c_user=100079852990600;xs=47%3AqvfD7ME7Az3O5Q%3A2%3A1657402173%3A-1%3A6299;fr=0z6kgQJ4Ul95YRlau.AWVD_vBA9GCmegqhIou9Rn4Hr4g.BiyfLF.xc.GLJ.0.0.BiyfNG.AWXUrH_Ys-g;wd=400x735;',
  ...
  'signup':'',
    ...
    if KQ == None:
      print(Fore.GREEN + Style.BRIGHT + " [" + str(n_yahoo) + "] Email Die : " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(Fore.RED + Style.BRIGHT + " [" + str(n_yahoo) + "] Email Live : " + yid + "@yahoo.com")
  process_menu()


def checkvalid():
  print ('')
  print (Fore.WHITE + Style.BRIGHT + ' [ Tool Facebook ]')
  print ('')
  n_valid = 0
  print (Fore.WHITE + Style.BRIGHT + " •KHÔNG HỖ TRỢ ĐỊNH DẠNG MAIL|PASS.")
  print (Fore.WHITE + Style.BRIGHT + " •FAKE IP TRƯỚC KHI CHECK. FACEBOOK BLOCK IP TRONG TRƯỜNG HỢP SPAM.")
  print (Fore.WHITE + Style.BRIGHT + " • TOOL CHECK SAI THÌ MỞ SOURCE CODE LÊN, RỒI THAY LẠI CÁI COOKIE FB MỚI VÀ CÁI DATA")
  fileEmail = open(input(Fore.WHITE + Style.BRIGHT + " -Nhập File Chứa Email(ex: email.txt) : ")).readlines()
  valid = input(Fore.WHITE + Style.BRIGHT + " -Nhập File Lưu Email LK Facebook(ex: validfb.txt) : ")
  for email_fb in fileEmail:
    ...
    'accept-language': 'vi-VN,vi;q=0.9,fr-FR;q=0.8,fr;q=0.7,en-US;q=0.6,en;q=0.5',
    'cookie':'sb=N7cFYD75qjxPpi5bheGd-xBH; datr=O7cFYOGqdMieLY7qGIq5LcPG; _fbp=fb.1.1641390145542.120452399; locale=vi_VN; m_pixel_ratio=1; wd=1360x625; fr=0FoWduBE4u5Jk7YWc.AWWJE06uiiw3Ojy2dqQuBVa2IBE.BiM_Fi.r5.AAA.0.0.BiNWn_.AWVWd28w9Cc'# <- TOOL CHECK SAI THÌ THAY CÁI COOKIE MỚI (KO CẦN ĐĂNG NHẬP VÀO TÀI KHOẢN FB)
}
    data = {
        'lsd':'AVrLciA8DS0',# <- TOOL CHECK SAI THÌ THAY DÒNG NÀY.
        'jazoest':'2865',# <- TOOL CHECK SAI THÌ THAY DÒNG NÀY.
        'email':email_fb,
        'did_submit':'Tìm kiếm',
}
    headers1 = {
    ...
    'accept-language': 'vi-VN,vi;q=0.9,fr-FR;q=0.8,fr;q=0.7,en-US;q=0.6,en;q=0.5',
    'cookie':'sb=N7cFYD75qjxPpi5bheGd-xBH; datr=O7cFYOGqdMieLY7qGIq5LcPG; _fbp=fb.1.1641390145542.120452399; locale=vi_VN; m_pixel_ratio=1; wd=1360x625; fr=0FoWduBE4u5Jk7YWc.AWWJE06uiiw3Ojy2dqQuBVa2IBE.BiM_Fi.r5.AAA.0.0.BiNWn_.AWVWd28w9Cc'# <- TOOL CHECK SAI THÌ THAY CÁI COOKIE MỚI (KHÔNG CẦN ĐĂNG NHẬP TÀI KHOẢN FB.)
}
    check = requests.post('https://mbasic.facebook.com/login/identify', headers=headers, data=data)
    valid_fb = re.search("Tìm kiếm không trả về kết quả nào. Vui lòng thử lại với thông tin khác.",check.text)
    if valid_fb == None:
      ...
      print (Fore.RED + Style.BRIGHT + " [" + str(n_valid) + "] |Không Liên Kết|" + email_fb)
  process_menu()
